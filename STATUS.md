...
Тесты (26 файлов, 1327 проверок)         | OK (1327/1327)
...
### Модульность
Модульная структура (core/region/modules/web/scripts/tests/docs/deploy). 26 файлов тестов, 1327 проверок.
...
### CI/CD (13.09.2026)
- .github/workflows/test.yml — 1327 тестов на каждый push
