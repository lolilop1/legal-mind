...
Тесты (26 файлов, 1555 проверок)         | OK (1555/1555)
...
### Модульность
Модульная структура (core/region/modules/web/scripts/tests/docs/deploy). 26 файлов тестов, 1555 проверок.
...
### CI/CD (13.09.2026)
- .github/workflows/test.yml — 1555 тестов на каждый push
